...
| --- | ---: | ---: | ---: | :---: |
| dropback_rate | 0.5984 | 0.5886 | -1.6% | ✅ |
| completion_pct | 0.647 | 0.6596 | +1.9% | ✅ |
| yards_per_attempt | 7.057 | 7.3692 | +4.4% | ✅ |
| air_yards_per_attempt | 7.7112 | 7.7665 | +0.7% | ✅ |
| int_rate_per_att | 0.0223 | 0.0231 | +3.3% | ✅ |
| sack_rate_per_dropback | 0.0663 | 0.0678 | +2.4% | ✅ |
| yards_per_carry | 4.2761 | 4.4582 | +4.3% | ✅ |
| explosive_rush_rate | 0.0438 | 0.0423 | -3.5% | ✅ |
| explosive_pass_rate | 0.0894 | 0.0958 | +7.1% | ✅ |
| fg_make_pct | 0.8517 | 0.8648 | +1.5% | ✅ |
| rz_td_rate | 0.5599 | 0.5284 | -5.6% | ✅ |
| plays_per_team_game | 67.8186 | 69.048 | +1.8% | ✅ |
| drives_per_team_game | 10.7433 | 10.808 | +0.6% | ✅ |
| points_per_team_game | 22.5643 | 21.978 | -2.6% | ✅ |
| points_sd | 9.9268 | 8.5218 | -14.2% | ❌ |
| pass_attempts_per_team_game | 32.8192 | 31.362 | -4.4% | ✅ |
| rush_attempts_per_team_game | 23.9902 | 24.878 | +3.7% | ✅ |
| penalties_per_team_game | 6.1618 | 4.8 | -22.1% | ❌ |
| penalty_yards_per_team_game | 50.0245 | 41.3683 | -17.3% | ❌ |
...
- **points/team-game −3% (was −12%) — V1.6 (`docs/v16_points_gap_plan.md`).** By impact: `CLOCK_SCALE = 0.958` (M24 snap gaps ran ~1 s/play long → drives/team-game −3.3% → +1.2%); `rz_yac` table (RZ completions caught short now score at the empirical goal-line-reach rate — `pass_comp TD/pl` yl 3–4 0.63 → 0.77); two punt bugs (field position); RZ `air_yards` split (gl1..gl4); `PICK_SIX_RATE`/`SCOOP_SIX_RATE` were ~5× low. Ruled out: within-drive momentum (ρ≈0), scaling `PENALTY_HAZARD_SCALE`. `plays_per_team_game` empirical filter fixed like-for-like (62 → 68). Residual: `end_of_half` 8.8 v 6.85%, RZ pass-TD ~10 pp short yl 5–20 (M05 depth). No 2-pt.
