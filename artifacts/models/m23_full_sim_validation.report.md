...
| --- | ---: | ---: | ---: | :---: |
| dropback_rate | 0.5984 | 0.5894 | -1.5% | ✅ |
| completion_pct | 0.647 | 0.6569 | +1.5% | ✅ |
| yards_per_attempt | 7.057 | 7.31 | +3.6% | ✅ |
| air_yards_per_attempt | 7.7112 | 7.7794 | +0.9% | ✅ |
| int_rate_per_att | 0.0223 | 0.0229 | +2.6% | ✅ |
| sack_rate_per_dropback | 0.0663 | 0.0658 | -0.7% | ✅ |
| yards_per_carry | 4.2761 | 4.2507 | -0.6% | ✅ |
| explosive_rush_rate | 0.0438 | 0.0395 | -9.9% | ✅ |
| explosive_pass_rate | 0.0894 | 0.0976 | +9.1% | ✅ |
| fg_make_pct | 0.8517 | 0.8698 | +2.1% | ✅ |
| rz_td_rate | 0.5599 | 0.5445 | -2.7% | ✅ |
| plays_per_team_game | 61.9951 | 66.4425 | +7.2% | ✅ |
| drives_per_team_game | 10.7433 | 10.4775 | -2.5% | ✅ |
| points_per_team_game | 22.5643 | 19.8725 | -11.9% | ❌ |
| points_sd | 9.9268 | 8.3816 | -15.6% | ❌ |
| pass_attempts_per_team_game | 32.8192 | 30.2025 | -8.0% | ✅ |
| rush_attempts_per_team_game | 23.9902 | 23.8575 | -0.6% | ✅ |
| penalties_per_team_game | 6.1618 | 4.705 | -23.6% | ❌ |
| penalty_yards_per_team_game | 50.0245 | 41.3817 | -17.3% | ❌ |
| dpi_per_team_game | 0.5239 | 0.3875 | -26.0% | ❌ |
