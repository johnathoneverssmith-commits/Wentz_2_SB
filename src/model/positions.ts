...
export const AGING_CURVES: Readonly<Record<Position, { dev: number; decline: number }>> = {
  ...
  ILB: { dev: 26, decline: 31 },
  OLB: { dev: 26, decline: 31 },
...
> = {
  ...
  ILB: { speed: 84, acceleration: 86, agility: 82, strength: 78, jumping: 78 },
  OLB: { speed: 85, acceleration: 87, agility: 83, strength: 80, jumping: 79 },
...
> = {
  ...
  ILB: { base: 65, spread: 21 },
  OLB: { base: 64, spread: 23 },
