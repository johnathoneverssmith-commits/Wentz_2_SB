...
| Phase E rating-layer validation | Python | **V1 done** — `24_rating_layer_validation` (§23): all 11 family magnitudes analytically 1.0× the historical anchor; larger-sample league check (120 pairs) shows the centred layer costs ~1.2 pts/team-game and slightly narrows margin variance — a §13.6 joint-calibration item (same "per-play right, drive-model wrong" pattern as the §22 points gap) |
